...
{
	document.getElementById("waitmessage").innerHTML = "Por favor espere, cargando...";
...
function OKClick()
{
	...
	{
		document.getElementById("worderror").innerHTML = "La palabra que ha escrito contiene caracteres no válidos. Por favor escriba sólo letras en el cuadro de arriba.";
...
function CheckClick()
{
	...
	if (ErrorsFound > 0 && EmptyFound > 0)
		...
		document.getElementById("welcomemessage").innerHTML = ErrorsFound + (ErrorsFound > 1 ? " errores" : " error") + " encontrados.";
